...
/**
 * Parser spécifique au format texte ".scene".
 * Déplacé depuis l'ancien `SceneFileParser` pour séparer la logique de format
 */
public class SceneTextParser {
    ...
    // Reste des méthodes (parseSize, parseOutput, parseCamera, etc.)
    // Pour garder le patch concis, je réutilise la logique existante :
